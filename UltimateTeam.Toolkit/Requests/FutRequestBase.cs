...
namespace UltimateTeam.Toolkit.Requests
{
    public abstract class FutRequestBase
    {
        ...
        protected void AddCommonHeaders(HttpMethod methodOverrideHeader = null)
        {
            ...
            HttpClient.AddRequestHeader(NonStandardHttpHeaders.RequestedWith, "ShockwaveFlash/23.0.0.162");
        ...
        protected void AddCaptchaHeaders()
        {
            ...
            HttpClient.AddRequestHeader(NonStandardHttpHeaders.EmbedError, "true");
            HttpClient.AddRequestHeader(NonStandardHttpHeaders.Route, "https://utas.external.s2.fut.ea.com");
        ...
        protected void AddPinHeaders()
        {
            ...
            AddUserAgent();
            HttpClient.AddRequestHeader(HttpHeaders.ContentType, "application/json");
            HttpClient.AddRequestHeader("X-Requested-With", "ShockwaveFlash/23.0.0.162");
        ...
        {
            HttpClient.AddRequestHeader(HttpHeaders.UserAgent, "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.94 Safari/537.36");
        }
